package ru.SSP55.max.bots.api.objects.message.body;

import com.fasterxml.jackson.annotation.JsonProperty;
import lombok.NonNull;
import ru.SSP55.max.bots.api.objects.MaxApiObject;
import ru.SSP55.max.bots.api.objects.message.body.attachments.Attachment;
import ru.SSP55.max.bots.api.objects.message.body.markup.MarkupElement;
