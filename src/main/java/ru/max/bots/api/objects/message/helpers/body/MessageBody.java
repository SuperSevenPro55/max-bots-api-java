package ru.max.bots.api.objects.message.helpers.body;

import com.fasterxml.jackson.annotation.JsonProperty;
import lombok.NonNull;
import ru.max.bots.api.interfaces.MaxApiObject;
import ru.max.bots.api.objects.message.helpers.body.attachment.Attachment;
import ru.max.bots.api.objects.message.helpers.body.markup.MarkupElement;
